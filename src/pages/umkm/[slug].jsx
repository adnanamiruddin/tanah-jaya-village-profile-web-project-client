    ...
    <div className="pb-4 md:px-24 md:mt-12 md:pb-10">
      ...
      <div className="bg-white p-3 border border-gray-300 rounded-lg">
        ...
        <div className="py-4 px-1">
          <h4 className="text-3xl font-bold">Kedai Papai</h4>
          ...
          <Link href={`/umkm/${slug}`}>
            <p className="mt-5 text-white font-semibold bg-sky-500 py-2 px-5 rounded hover:bg-sky-400 transition duration-300 w-max flex justify-center items-center gap-2.5">
