...
const HrefGradientButton = ({ href, children }) => {
  return (
    <Link
      href={href}
      className="mt-2 bg-gradient-to-br from-sky-800 to-sky-400 text-white font-semibold text-lg rounded-lg py-2 flex justify-center items-center hover:brightness-125"
    >
      {children}
      ...
      <div className="mt-10 md:mt-24">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center">
            ...
            />
            <h2 className="text-2xl font-bold mt-4">MUHAMMAD RIJAL, S.E.</h2>
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-3 gap-y-6 mb-6">
          ...
          <HomePopulationAdministration amount={111} type="Mutasi Penduduk">
            <IoIosMove className="text-5xl" />
          </HomePopulationAdministration>
          <HomePopulationAdministration amount={111} type="Penduduk Sementara">
            <GiTemporaryShield className="text-5xl" />
          </HomePopulationAdministration>
        </div>
          ...
          <div className="flex justify-center flex-wrap gap-y-2">
            ...
            <div className="w-[40%]">
              <HomePopulationAdministration amount={2222} type="SMP">
                <Fa6School className="text-5xl" />
              </HomePopulationAdministration>
            </div>
            <div className="w-full">
              <HomePopulationAdministration amount={666} type="SMA/SMK">
                <FaSchoolFlag className="text-5xl" />
              </HomePopulationAdministration>
            </div>
          </div>
        </div>
